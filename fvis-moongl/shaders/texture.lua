...
local prog, vsh, fsh = gl.make_program({vertex="fvis-moongl/shaders/texture.vert",
    fragment="fvis-moongl/shaders/texture.frag"})
gl.delete_shaders(vsh, fsh)

-- load and create 2 textures -------------------------------------------------
local texture1 = new_texture("fvis-moongl/resources/textures/wood.png")
